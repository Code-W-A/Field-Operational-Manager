  ...
  return (
    <PageShell>
      <SectionHeader
        ...
        description="KPI-uri, oportunități prioritizate după ToDo și taskuri curente"
        action={
          <Button
            size="sm"
      ...
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        <Card className="crm-card">
          <CardContent className="p-4">
            <p className="text-xs text-neutral-500">Taskuri deschise</p>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Panel title="Taskuri" subtitle="Overdue / Today / Upcoming">
          {loading ? (
            <p className="text-xs text-neutral-500">Se încarcă...</p>
          ) : (
      ...
      {loading ? null : (
        <div className="rounded-lg border border-neutral-200 bg-neutral-50 p-3 text-xs text-neutral-500">
          ...
          Taskurile și oportunitățile afișate respectă filtrele de acces owner/share/custom.
