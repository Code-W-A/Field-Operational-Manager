            ...
            <Card>
              ...
              <CardContent>
                <div className="text-sm flex flex-wrap">
                  ...
                  <div className={`mb-4 ${lucrare.timpSosire && lucrare.timpPlecare ? 'w-1/2 pl-2' : 'w-1/2 pr-2'}`}>
                  ...
                  <div className={`mb-4 ${lucrare.tipLucrare === "Intervenție în contract" ? 'w-full' : 'w-1/2 pl-2'}`}>
