...
const ITEMS: Array<{ code: TimesheetCode; label: string; className: string }> = [
  ...
  { code: "WE", label: "WE (weekend)", className: "bg-sky-50 text-sky-900 border-sky-200" },
  ...
  { code: "SL", label: "SL (sărbătoare legală)", className: "bg-sky-50 text-sky-900 border-sky-200" },
