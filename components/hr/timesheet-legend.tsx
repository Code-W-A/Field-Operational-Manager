...
const ITEMS: Array<{ code: TimesheetCode; label: string; className: string }> = [
  ...
  { code: "WE", label: "WE (weekend)", className: "bg-blue-50 text-blue-700 border-blue-200" },
  ...
  { code: "SL", label: "SL (sărbătoare legală)", className: "bg-blue-50 text-blue-700 border-blue-200" },
