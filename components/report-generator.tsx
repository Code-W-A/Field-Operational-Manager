...
export const ReportGenerator = forwardRef<HTMLButtonElement, ReportGeneratorProps>(
  ({ lucrare, onGenerate, disableEditing }, ref) => {
    ...
    return (
      <div className="space-y-4">
        {!disableEditing && <ProductTableForm products={products} onProductsChange={setProducts} />}
        <div className="flex justify-center mt-6">
          ...
          >
            ...
            {isGen ? "În curs..." : disableEditing ? "Descarcă PDF" : "Generează PDF"}
          </Button>
        </div>
      </div>
    )
