...
const BUBBLE_CONFIG = {
  maxWidth: "280px",        // Lățime maximă
  minWidth: "150px",        // Lățime minimă
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <div
            ...
            className={cn(
              // Fill the available width inside each personal column with more space on the right - cu max-width pentru texte lungi
              "group cursor-pointer rounded-lg border px-3 py-1.5 text-left transition-colors overflow-hidden w-[calc(100%-5px)] ml-1.5 mr-0",
